      ...
      <SafeAreaView style={{ flex: 1 }} edges={["top"]}>
        ...
        <View style={styles.titleBlock}>
          ...
          <Text style={styles.pageSubtitle}>
            142 movements · video demos with coaching cues
          </Text>
        </View>
          ...
          {MUSCLES.map((m) => (
            ...
            >
              <Text
                style={[
                  styles.chipLabel,
                  { color: activeMusle === m.k ? "#000" : T.text },
                ]}
              >
                {m.k}
              </Text>
              <Text
                style={[
                  styles.chipCount,
                  { color: activeMusle === m.k ? "rgba(0,0,0,0.5)" : T.dim },
                ]}
              >
                {m.n}
              </Text>
              ...
              <View style={styles.exerciseInfo}>
                ...
                <View style={styles.tagRow}>
                  <View style={styles.tag}>
                    <Text style={styles.tagText}>{e.level}</Text>
                  </View>
                  <View style={styles.tag}>
                    <Text style={styles.tagText}>{e.equip}</Text>
                  </View>
                </View>
              </View>
            </TouchableOpacity>

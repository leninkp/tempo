              ...
              return (
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.setNum,
                      { color: isDone ? T.muted : isActive ? T.text : T.dim },
                    ]}
                  >
                  ...
                  <Text
                    style={[
                      styles.setCellLg,
                      {
                        color: isUp ? T.dim : T.text,
                        fontSize: isActive ? 22 : 16,
                      },
                    ]}
                  >
                    {s.weight}
                    {!isUp && <Text style={styles.cellUnit}> kg</Text>}
                  </Text>
                  <View
                    style={{
                      flex: 1,

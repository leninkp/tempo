        ...
        <View style={styles.topBar}>
          ...
          <Svg width={18} height={18} viewBox="0 0 18 18" fill="none">
            ...
            <Path d="M9 1.5v2M9 14.5v2M1.5 9h2M14.5 9h2M3.5 3.5l1.4 1.4M13.1 13.1l1.4 1.4M3.5 14.5l1.4-1.4M13.1 4.9l1.4-1.4"
              stroke={T.text} strokeWidth={1.4} strokeLinecap="round" />
          </Svg>
        </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.identity}>
            ...
            <View style={{ flex: 1, minWidth: 0 }}>
              ...
              <View style={styles.rankChip}><Text style={styles.rankText}>Challenger</Text></View>
            </View>
          </View>
          ...
          <View style={styles.statsStrip}>
            {STATS.map((s, i) => (
              <View key={s.k} style={[styles.statCell, i > 0 && styles.statCellBorder]}>
                ...
                <View style={styles.sectionList}>
                  {sec.rows.map((r, i) => (
                    ...
                    >
                      ...
                      <Text style={[styles.rowLabel, r.danger && { color: T.coral }]}>{r.label}</Text>
                      {r.value && (
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                          {r.tag && <View style={[styles.tagDot, { backgroundColor: r.tag }]} />}
                          <Text style={styles.rowValue}>{r.value}</Text>
                        </View>
                      )}
                      {!r.danger && (
                        <Svg width={7} height={12} viewBox="0 0 7 12" fill="none">
                          <Path d="M1 1l5 5-5 5" stroke={T.dim} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
                        </Svg>
                      )}
                    </TouchableOpacity>
                  ))}
...
const styles = StyleSheet.create({
  ...
  avatarWrap: {
    ...
    backgroundColor: '#1d1d1d', borderWidth: 1, borderColor: T.border,
    alignItems: 'center', justifyContent: 'center', position: 'relative',
  },
  avatarText: { fontSize: 28, fontWeight: '600', color: T.text, letterSpacing: -0.5 },
  levelBadge: {
  ...
  levelBadgeText: { fontFamily: T.mono, fontSize: 10, color: '#000', fontWeight: '700' },
  name: { fontSize: 26, fontWeight: '600', color: T.text, letterSpacing: -0.8, lineHeight: 30, marginBottom: 4 },
  since: { fontFamily: T.mono, fontSize: 10, color: T.dim, letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 8 },
  rankChip: {
    alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6,
    backgroundColor: `${T.lime}14`, borderWidth: 1, borderColor: `${T.lime}33`,
  },
  rankText: { fontFamily: T.mono, fontSize: 10, color: T.lime, letterSpacing: 0.8, textTransform: 'uppercase', fontWeight: '600' },
  statsStrip: {
    flexDirection: 'row', marginHorizontal: 24, marginBottom: 24,
    borderRadius: 16, overflow: 'hidden',
    backgroundColor: '#0b0b0b', borderWidth: 1, borderColor: T.border,
  },
  statCell: { flex: 1, padding: 16, paddingHorizontal: 12, alignItems: 'center' },
  statCellBorder: { borderLeftWidth: 1, borderLeftColor: T.border },
  statVal: { fontSize: 22, fontWeight: '600', color: T.text, letterSpacing: -0.6, lineHeight: 26, marginBottom: 6 },
  statKey: { fontFamily: T.mono, fontSize: 10, color: T.dim, letterSpacing: 1, textTransform: 'uppercase' },
  sections: { paddingHorizontal: 24, gap: 22, paddingBottom: 16 },
  sectionBlock: {},
  sectionTitle: { fontFamily: T.mono, fontSize: 10, color: T.dim, letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 8, paddingHorizontal: 4 },
  sectionList: { borderRadius: 16, overflow: 'hidden', backgroundColor: '#0b0b0b', borderWidth: 1, borderColor: T.border },
  row: {
  ...
  coachAvatar: {
    width: 26, height: 26, borderRadius: 13,
    backgroundColor: '#222', borderWidth: 1, borderColor: T.border,
    alignItems: 'center', justifyContent: 'center',
  },
  coachAvatarText: { fontFamily: T.mono, fontSize: 9, color: T.muted },
  rowLabel: { flex: 1, fontSize: 15, fontWeight: '500', color: T.text, letterSpacing: -0.2 },
  tagDot: { width: 6, height: 6, borderRadius: 3, marginRight: 6 },
  rowValue: { fontSize: 13, color: T.muted, letterSpacing: -0.1 },
  version: { paddingVertical: 14, textAlign: 'center', fontFamily: T.mono, fontSize: 10, color: T.dim, letterSpacing: 0.6 },
});

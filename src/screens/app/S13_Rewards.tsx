...
const ACHIEVEMENTS = [
  {
    k: "Iron week",
    desc: "4 sessions in a single week",
    icon: "✱",
    unlocked: true,
    color: T.lime,
    xp: 150,
  ...
  {
    k: "Volume king",
    desc: "Log 50,000 kg total volume",
    icon: "▲",
    unlocked: false,
    color: T.coral,
    xp: 250,
        ...
        <View style={styles.topBar}>
          ...
          <View style={styles.xpChip}>
            <Svg width={10} height={10} viewBox="0 0 10 10">
              <Path
                d="M5 0l1.5 3.5L10 4l-2.8 2.4L8 10 5 8 2 10l0.8-3.6L0 4l3.5-0.5z"
                fill={T.amber}
              />
            </Svg>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={styles.xpTrack}>
                <View
                  style={[
                    styles.xpFill,
                    { width: `${(XP_CURRENT / XP_NEEDED) * 100}%` },
                  ]}
                />
              </View>
            </View>
          ...
          <View style={styles.section}>
            <View style={styles.streakCard}>
              ...
              <Text style={styles.streakSub}>
                Longest this program. Keep it alive.
              </Text>
              ...
              {ACHIEVEMENTS.map((a) => (
                ...
                >
                  ...
                  >
                    <Text
                      style={[
                        styles.achieveIconText,
                        { color: a.unlocked ? "#000" : T.dim },
                      ]}
                    >
                      {a.icon}
                    </Text>
                  ...
                  <Text
                    style={[
                      styles.achieveName,
                      { color: a.unlocked ? T.text : T.muted },
                    ]}
                  >
                    {a.k}
                  </Text>
                  ...
                  {a.unlocked ? (
                    <Text style={[styles.achieveStatus, { color: a.color }]}>
                      UNLOCKED · +{a.xp} XP
                    </Text>
                  ) : (
                    <>
                      ...
                      <Text style={styles.achievePercent}>
                        {Math.round((a.progress || 0) * 100)}% · +{a.xp} XP
                      </Text>
                    </>
                  )}
                </View>
          ...
          <View style={[styles.section, { marginBottom: 16 }]}>
            <View style={styles.leaderCard}>
              <View style={styles.leaderRank}>
                <Text style={styles.leaderRankText}>#4</Text>
              </View>
              <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  xpChip: {
    ...
    borderWidth: 1,
    borderColor: "rgba(246,184,78,0.3)",
  },
  xpText: {
    fontFamily: T.mono,
    fontSize: 11,
  ...
  streakCard: {
    ...
    borderWidth: 1,
    borderColor: "rgba(246,184,78,0.22)",
  },
  streakRow: {
    flexDirection: "row",
    alignItems: "baseline",
